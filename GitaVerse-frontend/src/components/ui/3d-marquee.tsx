      ...
      <div className="flex size-full items-center justify-center">
        <div className="size-[1720px] shrink-0 scale-50 sm:scale-75 lg:scale-100">
          <div
            ...
            className="relative top-96 right-[40%] grid size-full origin-top-left grid-cols-4 gap-8 transform-3d"
          >
                ...
                {subarray.map((image, imageIndex) => (
                  <div className="relative" key={imageIndex + image}>
                    ...
                    <motion.img
                      ...
                      className="aspect-[1024/1024] rounded-lg object-cover ring ring-gray-950/5 hover:shadow-2xl"
                      width={1024}
                      height={1024}
                    />
                  </div>
